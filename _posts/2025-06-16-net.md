...
[AC1-GigabitEthernet0/0/1]p t p v 1
...
[Agg_SW1]dhcp en
[Agg_SW1]int vl 11
[Agg_SW1-Vlanif11]dhcp se re
[Agg_SW1-Vlanif11]dhcp relay server-ip 172.16.11.1 
```
...
[Agg_SW2]dhcp e
[Agg_SW2]int vl 13
[Agg_SW2-Vlanif13]dhcp se re
[Agg_SW2-Vlanif13]dhcp relay server-ip 172.16.13.1 
```
...
[Core_RT_AR3260]ip route-static 172.23.10.0 24 172.20.50.10
```
