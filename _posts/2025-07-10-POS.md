...
### 接下来是项目仓库，其中的`README`文档会告知如何下载，在此不再赘述<br> 即使在有代理的情况下也不能保证连接质量 <br> 所以使用国内镜像源进行加速下载
[https://github.com/PixelOS-AOSP/manifest][PixelOS-AOSP]

### 以下链接会告知如何配置<br>此处使用清华大学提供的镜像服务
...
### 修改完成以后同步代码 <br> 记录一下遇到的问题<br> 就是其中因为代理问题造成的克隆中断，导致最后的检出环节出现问题
