...
[SW1-ZXB-Vlan-interface100]acl a 3000
...
[SW1-ZXB-acl-ipv4-adv-3001]
[SW1-ZXB-acl-ipv4-adv-3001]int v 100
[SW1-ZXB-Vlan-interface100]packet-filter 3000 outbound 
...
[RT1-ZXB-ospf-1]i d
[RT1-ZXB-ospf-1]
[RT1-ZXB-ospf-1]acl number 3000
[RT1-ZXB-acl-ipv4-adv-3000]rule 5 permit tcp source 172.16.30.0 0.0.0.255 destination 10.10.2.0 0.0.0.255 destination-port eq telnet
[RT1-ZXB-acl-ipv4-adv-3000]rule 10 deny tcp source any destination 10.10.2.0 0.0.0.255 destination-port eq telnet
[RT1-ZXB-acl-ipv4-adv-3000]int g0/2
[RT1-ZXB-GigabitEthernet0/2]packet-filter 3000 outbound
{% endhighlight %}
